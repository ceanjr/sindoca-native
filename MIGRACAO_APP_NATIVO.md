...
- [x] Testar permissões de notificação no dispositivo físico
...
- [x] Migrar Conquistas (`app/conquistas`)
- [x] Migrar Razões (`app/razoes`)
- [x] Migrar Surpresas (`app/surpresas`)
- [x] Migrar Dashboard (`app/dashboard`)
- [x] Migrar Legado (`app/legado`)

#### 4.7 Stories

- [x] Migrar componente de Stories completo
- [x] Implementar swipe between stories (PanGestureHandler)
- [x] Barra de progresso animada (Reanimated)
- [x] Tap para pausar/avançar
- [x] Testar transições fluidas
...
- [x] Testar build local primeiro:
  - [x] `npx expo run:android`
  - [x] `npx expo run:ios`
